 ...
 */
public class Slip27b extends Frame implements ActionListener, ItemListener {
   ...
   */
  public Slip27b(String directory, FilenameFilter filter) {
  ...
  public static void main(String args[]) throws IOException {
    ...
    f = new Slip27b(directory, filter);
